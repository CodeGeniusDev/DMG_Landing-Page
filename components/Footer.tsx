    ...
    <footer className="bg-neutral-900/50 z-10 border-t border-white/10">
      <div className="max-w-container mx-auto py-12 px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="space-y-4">
            ...
            <p className="text-sm text-slate-400">
              High-performance websites and data-driven marketing for ambitious
              SMBs.
            </p>
            <div className="flex space-x-4">
              {socialLinks.map((item) => (
                <a
                  key={item.name}
                  href={item.href}
                  className="text-slate-400 hover:text-white transition-colors opacity-70 hover:opacity-100"
                >
          ...
          <div className="mt-8 md:mt-0">
            ...
            <ul className="mt-4 space-y-2 text-base text-slate-400">
              <li>
                1408 Mt Zion Rd, Union, <br />
                KY 41091, United States
              </li>
              <li>
                <a
                  href="tel:513-993-5166"
              ...
              <li>
                <a
                  href="mailto:info@totalqualitymedia.com"
                  className="hover:text-white"
                >
                  info@totalqualitymedia.com
                </a>
              </li>
            </ul>
          </div>
        ...
        <div className="mt-12 border-t border-white/10 pt-8 flex flex-col sm:flex-row justify-between items-center text-sm text-slate-400">
          <p>
            &copy; {new Date().getFullYear()} TOTAL QUALITY MEDIA LLC. All
            rights reserved.
          </p>
