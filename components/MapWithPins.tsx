...
const centralStates = {
  ...
  AR: {
    path: "M340 335L350 335L350 355L335 355L335 345L340 335",
    pin: [342, 345],
  },
  TX: {
    path: "M220 360L280 360L290 400L260 410L220 390L220 360",
    pin: [250, 380],
  },
  LA: {
    path: "M330 360L340 360L355 370L345 380L330 375L330 360",
    pin: [340, 370],
  },
};

const Pin: React.FC<{ cx: number; cy: number; delay: number }> = ({
  cx,
  cy,
  delay,
}) => {
...
export const MapWithPins: React.FC = () => {
  return (
    <svg
      viewBox="180 180 220 250"
      className="w-full max-w-sm h-auto drop-shadow-2xl"
      aria-label="Map of the Central United States with animated location pins"
    >
      <defs>
